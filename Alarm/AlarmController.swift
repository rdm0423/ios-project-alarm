...
class AlarmController {
    ...
    func loadFromPersistentStorage() {
        guard let alarms = NSKeyedUnarchiver.unarchiveObjectWithFile(filePath(kAlarms)) as? [Alarm] else {
            return
        }
        self.alarms = alarms
    }
...
extension AlarmScheduler {
    ...
    func scheduleLocalNotification(alarm: Alarm) {
        ...
        localNotification.alertBody = "Alarm: \(alarm.name)"
        localNotification.soundName = "Zings1.mp3"
